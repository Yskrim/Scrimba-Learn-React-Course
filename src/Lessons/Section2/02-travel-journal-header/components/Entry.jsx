        ...
        <main>
            <div className='article-card'>
                <div className="article-img-container">
                    <img className="article-image" src='https://scrimba.com/links/travel-journal-japan-image-url'alt='card-image' />
                </div>
                ...
                <div className="article-card-content">
                    ...
                    <p className="article-card-decription">Mount Fuji is the tallest mountain in Japan, standing at 3,776 meters (12,380 feet). Mount Fuji is the single most popular tourist site in Japan, for both Japanese and foreign tourists.
                    </p>
                </div>
            </div>
            <div className='article-card'>
